-- AEDRIN Complete System Migration - FINAL VERSION
-- Created: 2024-12-22
...
-- Schedule cleanup functions (if supported)
-- SELECT cron.schedule('cleanup-autosaves', '0 2 * * *', 'SELECT cleanup_old_autosaves();');
-- SELECT cron.schedule('cleanup-cache', '0 3 * * *', 'SELECT cleanup_expired_analysis_cache();');