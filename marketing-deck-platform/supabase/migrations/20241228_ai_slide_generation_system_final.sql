-- AI Slide Generation System Database Schema (FINAL CORRECTED VERSION)
-- Migration for comprehensive slide generation pipeline
-- This version matches existing schema types
...
-- Create final presentations table extensions (matching existing TEXT id type)
...
-- Create presentation drafts table for version history (matching existing TEXT id type)
...
-- Create QA results table (matching existing TEXT presentation id type)
